...
export const TESTIMONIALS: TestimonialItem[] = [
  ...
  },
  {
    ...
    after: "The Chrome extension autofilled my Australian details in one click, and the Interview Coach prepared me for tough scenario questions.",
