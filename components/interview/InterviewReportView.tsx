  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-ink-secondary">
              {session.stage_type === "coding"
                ? "Grounded, calibrated evaluation of your technical solutions and interview communication."
                : isCoaching
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        {/* Delivery Performance / Technical Communication */}
        <div className="rounded-lg border border-border bg-surface p-6 shadow-sm">
          <h2 className="text-base font-semibold text-ink">
            {session.stage_type === "coding" ? "Technical Communication & Pacing" : "Spoken Delivery Summary"}
          </h2>
          {session.stage_type === "coding" && report.delivery_summary.avg_wpm === 0 ? (
            <div className="mt-4 space-y-3">
              <div className="rounded border border-border bg-paper p-3">
                <div className="text-xs text-ink-muted">Submission Method</div>
                <div className="mt-1 flex items-center gap-2">
                  <Badge variant="accent">Written Solution</Badge>
                  <span className="text-xs text-ink-secondary">Evaluated on structure, logic, and clarity</span>
                </div>
              </div>
            ...
            <div key={idx} className="rounded border border-border bg-paper p-4">
              <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border pb-2">
                ...
                <div className="flex items-center gap-3 text-xs text-ink-muted">
                  {session.stage_type === "coding" && !q.wpm ? (
