...
function buildStyles(density: TemplateDensity): Record<string, React.CSSProperties> {
  ...
  return {
    ...
    roleBlock: { marginBottom: px(6, spacingScale), breakInside: "avoid", pageBreakInside: "avoid" },
    ...
    eduBlock: { marginBottom: px(5, spacingScale), breakInside: "avoid", pageBreakInside: "avoid" },
