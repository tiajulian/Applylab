...
-- ============================================================================================
-- Notable context on parsed job ads (token-optimisation pass, 2026-09-02)
-- ============================================================================================
...
-- never backfilled for rows parsed before this column existed, same as every other field here.
...
-- Standalone cover letters (feature flag cover_letter_v1); same statements as migrations/20260921000000_cover_letters.sql
...
-- ============================================================================================
-- Applied via supabase/migrations/20260921010000_atomic_rate_limiter.sql (atomic limiter +
-- concurrency leases). Mirrored below; see that file for rationale.
-- ============================================================================================
...
-- ============================================================================================
-- Applied via supabase/migrations/20260921020000_purge_stale_anonymous_users.sql
-- ============================================================================================
